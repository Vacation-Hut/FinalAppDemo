    ...
    <div className="App">
      ...
      <div class="flex-container">
        <div class="flex-item-leftside">
          <img
            src="https://res.cloudinary.com/dolq5ge5g/image/upload/v1683047660/promo_ny2mz2.png"
            alt="Vacation Hut Promotion"
          ></img>
        </div>
        <div class="flex-item-rightside">
          ...
          <p>
            ...
            <span className="promo">Accommodation facility</span>
          </p>
          <p>
          ...
          return (
            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0" key={index}>
              ...
              <div className="small">
                ...
                <span className="pay">{activity.price}</span>
                <br></br>
                <br></br>
